...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='KeyboardCategory',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('stagepiano', 'Stage Piano'), ('workstation', 'Workstation'), ('synth', 'Sintetizador'), ('digital_piano', 'Digital Piano'), ('arranger', 'Arranjador'), ('controller', 'Controlador MIDI')], max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Keyboard',
            fields=[
                ...
                ('categories', models.ManyToManyField(to='keyboards.keyboardcategory')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keyboard', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='evaluations', to='keyboards.keyboard')),
            ],
        ),
        migrations.CreateModel(
